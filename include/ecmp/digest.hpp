...
// SHA-256 (FIPS 180-4).  Used for semantic digests, assignment digests,
// persistence integrity and wire integrity.  No cryptographic authentication
// claim is made anywhere in ECMP Governor 1.0.0: the digest detects corruption
// and accidental divergence, it is not a MAC and does not authenticate peers.
class Sha256 {
 public:
...
// naming helper only: nothing in ECMP Governor ever treats a derived identity as
// proof of anything.
template <class Id>
